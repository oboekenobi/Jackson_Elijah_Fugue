...
namespace QuantumTek.QuantumDialogue
{
    ...
    {
        public static QD_DialogueHandler _instance;
        public Demo_DialogueAnimation da;
        public QD_Dialogue dialogue;
        [HideInInspector] public int currentConversationIndex = -1;
        [SerializeField] public QD_Conversation currentConversation;
        [SerializeField] public QD_MessageInfo currentMessageInfo;
